      ...
      <div className="max-w-7xl pt-8 mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
          ...
          <form
            ...
            className="bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-8 col-span-2 max-w-2xl w-full mx-auto"
          >
          ...
          <div className="shadow-xl rounded-2xl p-6 bg-white dark:bg-gray-800">
            ...
            <div className="flex gap-4 text-teal-600 dark:text-teal-300">
              ...
              <a href="https://youtube.com" target="_blank" className="hover:scale-110 transition-transform"><Youtube /></a>
            </div>
          </div>
        </div>
