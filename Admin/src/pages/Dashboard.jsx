...
export default function Dashboard() {
 ...
 return (
  <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 text-gray-900 flex ">
    {/* Sidebar */}
    <div
      ref={sidebarRef}
      className={` inset-y-0 left-0 z-30 w-64 shadow-md transform transition-transform duration-300 md:static md:translate-x-0 
    ...
    <div className="flex flex-1 h-screen overflow-hidden">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-3 sm:p-4 md:p-6 space-y-6 overflow-y-auto">
